...
import com.ahmadjanuar.ui.theme.AhmadJanuarTheme
...
fun Promotions() {
    LazyRow(
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.keyboard_logitech),
                title = "Fruit",
                subtitle = "Start @",
                header = "$1",
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.katalog_monitor),
                title = "Meat",
                subtitle = "Discount",
                header = "20%",
...
fun CategorySection() {
    Column(Modifier.padding(horizontal = 16.dp)) {
        ...
        Row(
            ...
            CategoryButton(
                text = "Mouse",
                icon = painterResource(id = R.drawable.katalog_mouse),
                backgroundColor = Color(0xffFEF4E7)
            )
            CategoryButton(
                text = "Keyboard",
                icon = painterResource(id = R.drawable.katalog_keyboard),
                backgroundColor = Color(0xffF6FBF3)
            )
            CategoryButton(
                text = "Monitor",
                icon = painterResource(id = R.drawable.katalog_monitor),
                backgroundColor = Color(0xffFFFBF3)
            )
            CategoryButton(
                text = "Speaker",
                icon = painterResource(id = R.drawable.katalog_speaker),
...
fun BestSellerItems() {
    LazyRow(
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.keyboard_mecha),
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.speaker),
                title = "Speker Logitech",
                price = "6.76",
                discountPercent = 20
            )
        }
